...
import IconProLifeTips from "../assets/icon-prolifetips.svg?react";
...
function LandingPageProLifeTips() {
          ...
          {activeTab === 'create' && (
            <div>
              <form onSubmit={handleSubmit} className="w-full max-w-2xl">
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    placeholder="e.g. 'Focus Hack Of The Day (3 Days)'"
              ...
              <div className="my-12">
                ...
                <a
                  className="mr-2 mb-4 cursor-pointer inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-sm border border-teal-500 text-teal-500 hover:bg-teal-500 hover:text-white"
                  onClick={() => setQuery('Grocery Hacks Pro Tip Series (3 Days)')}
                >
                  Grocery Hacks Pro Tip Series (3 Days)
                </a>
                <a
                  className="mr-2 mb-4 cursor-pointer inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-sm border border-teal-500 text-teal-500 hover:bg-teal-500 hover:text-white"
                  onClick={() => setQuery('Boost Your Focus Pro Tips (3 Days)')}
                >
                  Boost Your Focus Pro Tips (3 Days)
                </a>
                <a
                  className="mr-2 mb-4 cursor-pointer inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-sm border border-teal-500 text-teal-500 hover:bg-teal-500 hover:text-white"
                  onClick={() => setQuery('Negotiation Tips of the Day (3 Days)')}
                >
                  Negotiation Tips of the Day (3 Days)
                </a>
                <a
                  className="mr-2 mb-4 cursor-pointer inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-sm border border-teal-500 text-teal-500 hover:bg-teal-500 hover:text-white"
                ...
                <a
                  className="mr-2 mb-4 cursor-pointer inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-sm border border-teal-500 text-teal-500 hover:bg-teal-500 hover:text-white"
                  onClick={() => setQuery('Master Your Laundry Game (3 Days)')}
                >
                  Master Your Laundry Game (3 Days)
                </a>
                <a
                  className="mr-2 mb-4 cursor-pointer inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-sm border border-teal-500 text-teal-500 hover:bg-teal-500 hover:text-white"
                  onClick={() => setQuery('Dealing with People Like a Pro (3 Days)')}
                >
                  Dealing with People Like a Pro (3 Days)
                </a>
                <a
                  className="mr-2 mb-4 cursor-pointer inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-sm border border-teal-500 text-teal-500 hover:bg-teal-500 hover:text-white"
                  onClick={() => setQuery('Time-Saving Hacks You’ll Actually Use (3 Days)')}
                >
                  Time-Saving Hacks You’ll Actually Use (3 Days)
                </a>
              </div>
              <SuggestedSchedule />
            </div>
...
export default LandingPageProLifeTips;
